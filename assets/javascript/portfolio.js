...
$(document).ready(() => {
  const links = [
    {
      name: 'Discord',
      link: 'https://discord.gg/ha87Xk44dQ',
    },
    {
      name: 'Arkcrash.uk',
      link: 'https://arkcrash.uk',
    },
    {
      name: 'Selly store (BUY HERE)',
      link: 'https://arkcrash.sellix.io/',
    },
    {
      name: 'Power Proof',
      link: 'https://www.youtube.com/watch?v=POulfOVr324',
    }
  ];
  ...
  app.titleChanger(['Ark Crasher','255 Offical servers', 'Cheap prices', 'consistent power']);
